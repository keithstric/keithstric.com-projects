...
public class DebugToolbar {
	...
	private static HashMap<String, Object> toolbarConfig = null;

	private static String msgContext = null;
	 ...
	 */
	public static void log(String msg, String msgContext, String type) {
		...
		try {
			...
			if (conf == null) {
				...
				if (loaded) {
					...
					newMsg.putProperty("msgContext", FBSUtility.wrap((msgContext != null ? msgContext : DebugToolbar.msgContext)));
	...
	public static void info(String msg, String msgContext) {
	...
	public static void debug(String msg, String msgContext) {
	...
	public static void error(String msg, String msgContext) {
	 ...
	 */
	private static HashMap getToolbarConfig() {
		...
		try {
			if (toolbarConfig != null) {
				...
				final Map<Object, Object> sessionScope = (Map<Object, Object>) context.getApplication().getVariableResolver()
				...
				if (toolbarConf != null) {
					...
					DebugToolbar.toolbarConfig = toolbarConf;
					return toolbarConf;
					...
					DebugToolbar.toolbarConfig = config;
